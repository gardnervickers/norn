...
#[derive(Debug)]
pub(crate) enum TerminalPermit {
    Ordinary { _permit: OrdinaryPermit },
    Bundled { _permit: BundledPermit },
}

impl From<OrdinaryPermit> for TerminalPermit {
    fn from(value: OrdinaryPermit) -> Self {
        Self::Ordinary { _permit: value }
    }
}

impl From<BundledPermit> for TerminalPermit {
    fn from(value: BundledPermit) -> Self {
        Self::Bundled { _permit: value }
    }
}
